...
| destructive scanner remains advisory while EdgeNode RED | Scanner language must not imply clearance while RED destructive history remains unresolved | Manifest states scanner review remains advisory while EdgeNode stays RED and no allowlist is approved | PASS | migration-safety-agent | No destructive approval language was added. |
