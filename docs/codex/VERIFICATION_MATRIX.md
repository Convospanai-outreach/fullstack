...
| Live public URL status | Check live URLs from public internet before submission | `docs/audits/live-url-approval-readiness-checklist.md` marks all exact craftmyfunnel.live URLs as `UNKNOWN` until verified live | NOT_CHECKED | approval-readiness-agent | No live URL check performed in this docs-only pass |
