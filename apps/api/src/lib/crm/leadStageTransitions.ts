// Mirrors apps/web/src/lib/crm/leadStageTransitions.ts. apps/api and apps/web
// are separate deployables (Fastify vs Next.js) with no shared package for
// this logic, so this is a deliberate, exact-copy duplication rather than a
// cross-app import - keep the two files in sync if the state machine changes.
