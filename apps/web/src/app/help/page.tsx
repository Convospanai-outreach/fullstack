                ...
                <aside className="space-y-6">
                    ...
                    <div className="rounded-[28px] border border-white/10 bg-white/[0.03] p-6">
                        ...
                        <div className="mt-4 flex flex-wrap gap-3">
                            ...
                            <a href="mailto:support@convospan.com" className="rounded-full border border-white/10 px-4 py-2 text-sm text-slate-100 transition hover:border-amber-300/40 hover:bg-white/[0.04]">
                                Email support
                            </a>
                        </div>
                    </div>
