  ...
  return (
    <div className="p-8 min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto space-y-8">
        ...
        {loading && <div className="text-foreground">Loading usage data...</div>}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
              {summary?.map((card) => (
                <GlassCard key={card.label} className="p-5 flex items-center gap-4">
                  <div className="h-10 w-10 rounded-xl bg-muted flex items-center justify-center text-success">
            ...
            <GlassCard className="p-6">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm text-left">
                  ...
                  <tbody className="divide-y divide-border">
                    {data.teams.map((team) => (
                      <tr key={team.id} className="text-foreground">
                        <td className="py-3 pr-4">
