...
export default function CRMIntegrationPage() {
    ...
    const handleConnect = async (provider: string) => {
        ...
        // Here we would window.location.href = `${(process.env['NEXT_PUBLIC_API_URL'] || "/api/proxy")}/auth/crm/${provider}`
    ...
    const handleSync = async (provider: string) => {
        toast.promise(
            fetch((process.env['NEXT_PUBLIC_API_URL'] || "/api/proxy") + "/crm/sync", {
                method: "POST",
