            ...
            {newSecret && (
                <div className="glass p-6 rounded-2xl border border-green-500/30">
                    ...
                    <div className="mt-4 flex gap-2">
                        ...
                        <Button variant="outline" onClick={() => copyToClipboard(newSecret)} aria-label="Copy newly created API key">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                <div className="space-y-4 flex-1">
                                    ...
                                    <div className="flex items-center gap-2 bg-black/40 border border-white/5 rounded-xl px-4 py-3 font-mono text-xs w-full max-w-xl group/key">
                                        ...
                                        {key.legacy && (
                                            <span className="text-amber-300 shrink-0">Legacy rotation pending</span>
                                        )}
                                    </div>
                                </div>
