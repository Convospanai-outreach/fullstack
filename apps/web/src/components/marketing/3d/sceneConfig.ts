...
export const SCROLL_ACTS = [
  ...
  { id: "signal",   label: "NetJana Buyer Signals",   shortLabel: "SIGNAL",   progress: 0.42 },
  { id: "outreach", label: "CMF Core AI Outreach",    shortLabel: "OUTREACH", progress: 0.56 },
  { id: "human",    label: "Human Conversion Moat",   shortLabel: "HUMAN",    progress: 0.70 },
  { id: "edge",     label: "Covospan EDGE",           shortLabel: "EDGE",     progress: 0.84 },
  { id: "revenue",  label: "Qualified Revenue",       shortLabel: "REVENUE",  progress: 1.0  },
] as const;
