...
import { stepGroups } from "./stepDefinitions";
    ...
    return (
        <div className="p-3 space-y-3">
            ...
            <Tabs defaultValue="steps">
                ...
                <TabsContent value="steps" className="mt-3 max-h-80 space-y-4 overflow-y-auto">
                    ...
                    {filteredGroups.length === 0 && (
                        <p className="py-6 text-center text-sm text-muted-foreground">No steps match &quot;{query}&quot;</p>
                    )}
                </TabsContent>

                <TabsContent value="conditions" className="mt-3">
                    <p className="py-6 text-center text-sm text-muted-foreground">Conditions are coming soon.</p>
                </TabsContent>
            </Tabs>
        </div>
    );
