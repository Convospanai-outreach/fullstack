...
export async function proxy(req: NextRequest) {
    ...
    const publicApiPrefixes = ["/api/health", "/api/metrics", "/api/test-auth", "/api/contact", "/api/help", "/api/waitlist", "/api/proxy/waitlist", "/api/proxy/extension", "/api/support/contact", "/api/proxy/landing-agent/public", "/api/landing-agent/public"];
