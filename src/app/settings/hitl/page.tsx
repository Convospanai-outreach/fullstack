...
export default function HITLPage() {
    ...
    if (loading) return <div className="p-8 text-white">Loading interception queue...</div>;
        ...
        <div className="space-y-8 max-w-6xl">
            ...
            <GlassCard className="p-8 space-y-6">
                <div className="flex items-center gap-3 border-b border-white/10 pb-6">
                    ...
                    <h3 className="text-xl font-bold text-white">Interception Queue</h3>
                </div>
                ...
                {pending.length === 0 ? (
                    <div className="py-12 text-center space-y-4">
                        ...
                        <p className="text-gray-500 text-sm">All caught up! No actions require human review.</p>
                    </div>
                ) : (
                    <div className="space-y-4">
                        {pending.map((req) => (
                            <div key={req.id} className="p-6 bg-white/5 rounded-2xl border border-white/5 hover:border-white/10 transition-all group">
                                <div className="flex flex-col md:flex-row justify-between gap-6">
                                    <div className="space-y-4 flex-1">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="p-4 bg-black/40 rounded-xl border border-white/5 font-mono text-[11px] text-gray-400 overflow-x-auto">
