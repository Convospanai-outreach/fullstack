        ...
        <GovernanceLayout>
            <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-xl font-bold text-white">Safety Engine Configuration</h2>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    <Card title="Restricted Vocabulary" subtitle="AI will be blocked from generating these exact phrases">
                    ...
                    <Card title="Competitor Awareness" subtitle="Flag messages that mention these rival entities">
                        <div className="flex gap-2 mb-4">
                            <Input
                ...
                {/* Global Controls */}
                <div className="space-y-6">
                    <Card title="AI Governance Rules" subtitle="System-wide security toggles">
                        <div className="space-y-4">
                            <div className="flex items-center justify-between p-4 rounded-xl glass border border-white/5">
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        <label className="text-sm font-bold text-white block">PII Redaction</label>
                                        <span className="text-[10px] text-text-muted">Automatically mask emails, phones, and addresses</span>
                                    </div>
                                </div>
                                <input
                                    type="checkbox"
                            ...
                            <div className="flex items-center justify-between p-4 rounded-xl glass border border-white/5">
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        <label className="text-sm font-bold text-white block">Strict Output Mode</label>
                                        <span className="text-[10px] text-text-muted">Discard AI output if any guardrail is triggered</span>
                                    </div>
                                </div>
                                <input
                                    type="checkbox"
                            ...
                            <div className="p-4 rounded-xl bg-accent-blue/5 border border-accent-blue/20">
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center">
                                        <span className="text-xs text-text-secondary">Max Daily Outbound (per user)</span>
                                        <input
                                            type="number"
                                            value={policy.maxDailyMsgs}
                                            onChange={(e) => setPolicy({ ...policy, maxDailyMsgs: parseInt(e.target.value) })}
                                            className="bg-black/40 border border-white/10 rounded-lg px-2 py-1 w-20 text-right text-sm text-white focus:outline-none focus:ring-1 focus:ring-accent-blue transition-all"
                                        />
                                    </div>
                    ...
                    <div className="glass p-6 rounded-2xl border-dashed border-2 border-white/10 flex flex-col items-center text-center">
                        <Lock className="w-8 h-8 text-text-muted mb-3" />
                        <h4 className="text-sm font-bold text-white">Advanced Policy Editor</h4>
                        <p className="text-xs text-text-muted mt-1 mb-4">Upload custom RegEx patterns for deep content introspection.</p>
